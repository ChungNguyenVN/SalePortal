...
const tables = [
    ...
    { titleHistory: 'Nghỉ phép', typeRequire: 'Nghỉ không lương', userRequest: 'Nguyễn Văn C', dateRequire: '20/03/2020', status: 'pending', active: 'edit'  },
    { titleHistory: 'Nghỉ phép', typeRequire: 'Nghỉ không lương', userRequest: 'Nguyễn Văn D', dateRequire: '20/03/2020', status: 'active', active: 'delete'  },
    { titleHistory: 'Nghỉ phép', typeRequire: 'Nghỉ không lương', userRequest: 'Nguyễn Văn E', dateRequire: '20/03/2020', status: 'pending', active: 'edit'  },
]

const tablehead = ['#', 'Tiêu đề', 'Loại yêu cầu', 'Người yêu cầu', 'Ngày yêu cầu', 'Trạng thái', 'Hoạt động']
...
class ListProduct extends Component {
    ...
    render() {
        return(
            <React.Fragment>
                <Breadcrumbs title="Trang chủ" breadcrumbItem="Danh sách sản phẩm" className="mt-2" />

                <Card>
                    <CardHeader className="bg-transparent">
                        <Row>
                            <Col lg="6">
                                <h5 className="my-0">Danh sách Sản phẩm</h5>
                            </Col>
                            <Col lg="6">
                                        ...
                                        <Row>
                                            ...
                                            <div className="col-lg-6">
                                                <div className="form-group row">
                                                    <label htmlFor="example-text-input" className="col-md-3 col-form-label">Mã sản phẩm</label>
